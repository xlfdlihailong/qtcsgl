...
//    qDebug()<<row;
    ...
    hlog(plib::toChinese(parent->text(0).toStdString()),item->text(0));
    sigTransSystemNameAndStationName(parent->text(0).toStdString(),item->text(0).toStdString());
